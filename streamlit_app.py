...
with st.expander("Project thresholds", expanded=True):
    ...
    with c3:
        max_context_tokens = st.number_input(
            ...
            step=50_000,
            help=(
                "Provisional/editable ceiling. The supplied Professional Tasks guidelines confirm the 256k minimum "
                "but do not state a 1M maximum."
            ),
        )
    ...
    if estimates:
        ...
        json_report = {
            ...
            "notes": {
                ...
                "maximum_default": (
                    "1,000,000 is provisional/editable; supplied Professional Tasks guidelines do not state this ceiling"
                ),
            },
        }
...
- The **1,000,000 maximum default is provisional** because the supplied Professional Tasks guidelines confirm the 256k minimum but do not specify that ceiling. Change the field if project guidance confirms another limit.
"""
)
