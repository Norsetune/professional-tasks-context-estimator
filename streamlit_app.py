# Professional Tasks Context Range Estimator — v5
import tempfile
...
st.info(
    "**Minimum requirement:** Only files marked as **required for the prompt** count toward the 256k-token minimum. "
    "**Prompt text is excluded from this calculation.**  "
    "**Maximum context estimate:** The **entire uploaded source set plus the prompt** is counted to provide a conservative worst-case estimate."
)
...
- **Provisional model context limit: 1,000,000 tokens — edit if project guidance changes.**
"""
)
